...
public class MirroringAutoBuilder {
   ...
   */
  public static SendableChooser<Command> buildAutoChooser(BooleanSupplier mirror) {
    return buildAutoChooser("", mirror);
  }
   ...
   * @return SendableChooser populated with all autos
   */
  public static SendableChooser<Command> buildAutoChooser(String defaultAutoName, BooleanSupplier mirror) {
    return buildAutoChooserWithOptionsModifier(defaultAutoName, mirror, (stream) -> stream);
  }
  ...
  public static SendableChooser<Command> buildAutoChooserWithOptionsModifier(
      BooleanSupplier mirror, Function<Stream<PathPlannerAuto>, Stream<PathPlannerAuto>> optionsModifier) {
    return buildAutoChooserWithOptionsModifier("", mirror, optionsModifier);
  }
  ...
  public static SendableChooser<Command> buildAutoChooserWithOptionsModifier(
    ...
    for (String autoName : autoNames) {
      ...
      // PathPlannerAuto mirroredAuto = new PathPlannerAuto(defaultAutoName, true);
      // Command auto = new ConditionalCommand(mirroredAuto, nonMirroredAuto, mirror);
    ...
    optionsModifier
        ...
        .forEach(auto -> chooser.addOption(
            auto.getName(),
            new ConditionalCommand(new PathPlannerAuto(auto.getName(), true), auto, mirror)));
  ...
  public static boolean isHolonomic() {
    if (!MirroringAutoBuilder.isConfigured()) {
